...
public class ProjectListingClient {
    /**
     * Load all projects owned by an account.
     *
     * @param accountConfiguration
     * @return
     */
    public PhraseProjectsWrapperPojo listAllProjectsForAccount(PhraseAccountConfiguration accountConfiguration) {
        ...
        return new Gson().fromJson(response, PhraseProjectsWrapperPojo.class);
    }
}
